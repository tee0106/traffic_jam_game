...
public class StageD1{
	public static MediaPlayer bgm = new MediaPlayer( new Media (new File("sound/NextToYou.mp3").toURI().toString()));
	boolean CarEffectH[] = new boolean[5];
	boolean CarEffectV[] = new boolean[5];
    ...
    private void initialize(){
    	...
    	longh1.setImage(ImageStore.longh1);
    	shorth1.setImage(ImageStore.shorth1);
    	shorth2.setImage(ImageStore.shorth2);
    	shorth3.setImage(ImageStore.shorth3);
    	longv1.setImage(ImageStore.longv1);
    	shortv1.setImage(ImageStore.shortv3);
    	shortv2.setImage(ImageStore.shortv2);
    	shortv3.setImage(ImageStore.shortv4);
    	shortv4.setImage(ImageStore.shortv1);
    	gamebg.setImage(ImageStore.gamebg1);
				...
				for(int i=0; i<5; i++){
					if(CarEffectH[i]==false) {
						...
						for(int a=0; a<14; a++){
							...
							else if(checkIntersect(Object.get(0),Object.get(a))==true && a!=0 && a!=11){
								if(SpeedX>0){
									Object.get(pickH).setTranslateX(XX-5);
								}
								else if(SpeedX<0){
    	...
    	scene.setOnKeyPressed(new EventHandler<KeyEvent>(){
			...
			public void handle(KeyEvent event) {
				if (event.getCode()==KeyCode.RIGHT) {
					SpeedX = 150;
					for(int i=0; i<5; i++){ if(CarSelect==1 && CarEffectH[i]==false){moved=1;} }
					if(checkIntersect(Object.get(0),Object.get(11))==true){
						win=1;
						SpeedX = 0;
					...
					SpeedY = -150;
					for(int i=0; i<5; i++){ if(CarSelect==1 && CarEffectV[i]==false){moved=1;} }
	            }
