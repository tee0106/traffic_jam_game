...
public class StageD2 {
	public static MediaPlayer bgm = new MediaPlayer( new Media (new File("sound/FairyTail.mp3").toURI().toString()));
    ...
    private void initialize(){
    	...
    	shorth1.setImage(ImageStore.shorth3);
    	shorth2.setImage(ImageStore.shorth2);
    	shorth3.setImage(ImageStore.shorth1);
    	shorth4.setImage(ImageStore.shorth4);
    	longv1.setImage(ImageStore.longv1);
    	longv2.setImage(ImageStore.longv2);
    	shortv1.setImage(ImageStore.shortv3);
    	shortv2.setImage(ImageStore.shortv1);
    	shortv3.setImage(ImageStore.shortv2);
    	shortv4.setImage(ImageStore.shortv4);
    	gamebg.setImage(ImageStore.gamebg2);
				...
				for(int i=0; i<5; i++){
					if(CarEffectH[i]==false) {
						...
						for(int a=0; a<15; a++){
							...
							else if(checkIntersect(Object.get(0),Object.get(a))==true && a!=0 && a!=12){
								if(SpeedX>0){
									Object.get(pickH).setTranslateX(XX-5);
								}
								else if(SpeedX<0){
    	...
    	scene.setOnKeyPressed(new EventHandler<KeyEvent>(){
			...
			public void handle(KeyEvent event) {
				if (event.getCode()==KeyCode.RIGHT) {
					...
					if(checkIntersect(Object.get(0),Object.get(12))==true){
						win=1;
						SpeedX = 0;
